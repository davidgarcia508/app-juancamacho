...
export class CustomerTeam extends HTMLElement{
    constructor(){
        super();
        this.render();
        this.saveData();
                    ...
                    <div class="col-12">
                        <form id = "frmData">
                            <div class="row g-3">
                                ...
                                <div class="col-3">
                                    <label for="trainerAsociado" class="form-label">trainer Asociado</label>
...
customElements.define("customer-team",CustomerTeam);