...
export class ModuleSkill extends HTMLElement{
    constructor(){
        super();
        this.render();
        this.saveData();
    ...
    render(){
        this.innerHTML=/* html */`
        <div class="card">
        <h5 class="card-header">MODULE SKILL</h5>
        <div class="card-body">
            <div class="container">
                <div class="row g-3">
                    <div class="col-12">
                        <form id = "frmData">
                            <div class="row g-3">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control" id="idSkill" name="idSkill">
                                </div>
                            </div>
                            <div class="row g-3">
...
customElements.define("module-skill",ModuleSkill);